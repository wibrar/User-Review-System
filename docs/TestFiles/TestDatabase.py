...
class Database:
    ...
    try:
        ...
        db.close()
    @classmethod
    def TestDatabaseReset(cls):
        """
        This method is used only for testing. It resets the data in the database,
        so that subsequent module tests don't interfere with one another.
        :return:
        """
        db = shelve.open(cls.DBName, flag="c")
